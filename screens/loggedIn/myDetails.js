import { Button, SafeAreaView, TouchableOpacity, Text, TextInput, View } from 'react-native'
import React, { Component } from 'react'
import Header from '../Components/Header/Header'
import Form from '../Components/MyDetails/Form'
import DatePicker from 'react-native-date-picker'
import { AdjustmentsIcon, UserIcon, SearchIcon, BellIcon, ChevronLeftIcon, ChevronRightIcon, HeartIcon, MailIcon, UserCircleIcon, LocationMarkerIcon, PhoneIcon, } from "react-native-heroicons/outline"
  ...
  render() {
    ...
    return (
      <SafeAreaView>
        ...
        <TouchableOpacity onPress={() => this.updateDetails()} className='bg-black p-5 w-80 self-center rounded-3xl mt-5'>
          <Text className='text-center' style={{ color: 'white', fontWeight: '600' }}>Save Changes</Text>
        </TouchableOpacity>
