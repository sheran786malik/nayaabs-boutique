...
export default class ForgottenPassword extends Component {
    ...
    forgottenPassword(){
        auth
        .sendPasswordResetEmail(this.state.username).then((user) => {
            ...
            <SafeAreaView style={{ backgroundColor: '#FBFBFD', flex: 1 }}>
                ...
                <View className='self-center'>
                    ...
                    <Text className='self-center p-5' style={{
                        fontSize: 22,
                        fontWeight: '500'
                    }}>Please enter the email that is associated with your account</Text>
                    ...
                    <TouchableOpacity onPress={() => this.forgottenPassword()} className='bg-black p-5 w-80 self-center rounded-3xl mt-10'>
                        <Text className='text-center' style={{ color: 'white', fontWeight: '600' }}>Send  Instructions</Text>
                    </TouchableOpacity>
